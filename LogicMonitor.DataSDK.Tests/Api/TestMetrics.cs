...
namespace LogicMonitor.DataSDK.Tests.Api
{
   public class TestMetrics
   {
      ...
      [TestCase("Mac1-", "DotnetSDK", "Inst;anc-e_1.")] // failing due to ;
    ...
    public void TestGetInstanceBody()
    {
      ...
      string actualbody = metrics.getInstanceBody(resourceIds,dataSourceName,instanceName,instanceProperties,true);
      Assert.AreEqual(expectedbody, actualbody);
    ...
    {
      string expectedbody = "{\"resourceIds\":{\"system.displayname\":\"" + displayName + "\"},\"resourceProperties\":{},\"singleInstanceDS\":false}";
      string actualbody = metrics.getResourceBody(resourceIds,resourceProperties, true);
      Assert.AreEqual(expectedbody, actualbody);
    }
